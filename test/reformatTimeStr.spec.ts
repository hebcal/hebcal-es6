...
test('reformatTimeStr', () => {
  ...
  expect(reformatTimeStr('20:30', ' PM', {location: makeLocation('FR')})).toBe(
    '20:30'
  );
  expect(reformatTimeStr('20:30', ' PM', {location: makeLocation('IL')})).toBe(
    '20:30'
  );
  expect(reformatTimeStr('20:30', ' PM', {location: makeLocation('US')})).toBe(
    '8:30 PM'
  );
  expect(reformatTimeStr('20:30', ' PM', {location: makeLocation('CA')})).toBe(
    '8:30 PM'
  );
  expect(reformatTimeStr('20:30', ' PM', {location: makeLocation('BR')})).toBe(
    '8:30 PM'
  );
  expect(reformatTimeStr('20:30', ' PM', {location: makeLocation('MX')})).toBe(
    '20:30'
  );
  ...
  expect(reformatTimeStr('11:45', ' PM', {location: makeLocation('FR')})).toBe(
    '11:45'
  );
  expect(reformatTimeStr('11:45', ' PM', {location: makeLocation('IL')})).toBe(
    '11:45'
  );
  expect(reformatTimeStr('11:45', ' PM', {location: makeLocation('US')})).toBe(
    '11:45 AM'
  );
  expect(reformatTimeStr('11:45', ' PM', {location: makeLocation('CA')})).toBe(
    '11:45 AM'
  );
  expect(reformatTimeStr('11:45', ' PM', {location: makeLocation('BR')})).toBe(
    '11:45 AM'
  );
  expect(reformatTimeStr('11:45', ' PM', {location: makeLocation('MX')})).toBe(
    '11:45'
  );
  ...
  expect(reformatTimeStr('00:07', ' PM', {location: makeLocation('FR')})).toBe(
    '00:07'
  );
  expect(reformatTimeStr('00:07', ' PM', {location: makeLocation('IL')})).toBe(
    '00:07'
  );
  expect(reformatTimeStr('00:07', ' PM', {location: makeLocation('US')})).toBe(
    '12:07 AM'
  );
  expect(reformatTimeStr('00:07', ' PM', {location: makeLocation('CA')})).toBe(
    '12:07 AM'
  );
  expect(reformatTimeStr('00:07', ' PM', {location: makeLocation('BR')})).toBe(
    '12:07 AM'
  );
  expect(reformatTimeStr('00:07', ' PM', {location: makeLocation('MX')})).toBe(
    '00:07'
  );
});
...
test('reformatTimeStr-hour12', () => {
  ...
  expect(
    reformatTimeStr('23:56', ' PM', {
      location: makeLocation('IL'),
      hour12: true,
    })
  ).toBe('11:56 PM');
  expect(
    reformatTimeStr('23:56', ' PM', {
      location: makeLocation('US'),
      hour12: true,
    })
  ).toBe('11:56 PM');
  expect(
    reformatTimeStr('23:56', ' PM', {
      location: makeLocation('CA'),
      hour12: true,
    })
  ).toBe('11:56 PM');
  expect(
