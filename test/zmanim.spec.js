...
test('zmanim-denver', () => {
  ...
  expect(f.format(zman.sunsetOffset(72, false, true))).toBe('06/05/2020, 21:37:01');
});
...
test('Zmanim.formatISOWithTimeZone-2021', () => {
  ...
  expect(Zmanim.formatISOWithTimeZone('UTC', dt)).toBe('2021-01-31T07:30:50-00:00');
...
test('Zmanim.formatISOWithTimeZone-1948', () => {
  ...
  expect(Zmanim.formatISOWithTimeZone('UTC', dt)).toBe('1948-01-31T07:30:50-00:00');
  expect(Zmanim.formatISOWithTimeZone('America/New_York', dt)).toBe(
